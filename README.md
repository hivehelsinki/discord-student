...
curl -X POST http://localhost:3131/plant-watering \
  ...
  -d '{"plant_name":"Basil","location":"kitchen","message":"Time to water!","due_at":"2026-06-15T10:00:00Z","assignee_discord_id":"123456789012345678","assignee_name":"Alex","alert_type":"your_turn", "url": "https://intra.42.fr/endpoint-example-to-plant"}'
```
